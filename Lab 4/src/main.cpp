...
#define MESH_NAME "media/monkeyhead_smooth.dae"
/*----------------------------------------------------------------------------
----------------------------------------------------------------------------*/
...
GLuint CompileShaders()
{
	...
	AddShader(shaderProgramID, "media/simpleVertexShader.txt", GL_VERTEX_SHADER);
	AddShader(shaderProgramID, "media/simpleFragmentShader.txt", GL_FRAGMENT_SHADER);
